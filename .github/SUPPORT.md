# Getting help with elmr

Thanks for using elmr. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the elmr package](https://github.com/natverse/elmr/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/elmr/issues/new).
* If you're not sure:
