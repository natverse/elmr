...
* have CMTK available 
* have the [nat.flybrains](https://github.com/jefferislab/nat.flybrains) package
fully installed to provide bridging registrations
* can login to the FAFB catmaid server

We will make some of our examples run conditionally based on this.
...
run_vignette=full.bridging & catmaid_available
